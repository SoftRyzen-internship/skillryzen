...
import s from './FeedbackModalPageComponent.module.scss';
...
import { ModalAll } from 'ui-kit/components/ModalAll/ModalAll';

interface FeedbackModalPageProps {
  updateClickModal: (_value: boolean) => void;
}
export const FeedbackModalPageComponent = ({
  ...
  return (
    <>
      <ModalAll onClick={handleClickModal}>
